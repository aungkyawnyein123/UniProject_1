...
LEFT JOIN issue On issue.IssueID=issuelog.IssueID
    ...
    WHERE DATE(DueDate) < CURDATE() AND issuelog.status=0;";
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <table>
            <tr>
                <td class="float-left"><h4>Overdue Book List</h4></td>
        ...
        <tbody>
            ...
            <tr>
                    ...
                    <td width="20%" class="text-center">
                        <?php echo '<a class="btn btn-primary" href="MemberDetail.php?UserID='. $row->UserID.'">View Borrower</a>';?>&nbsp
