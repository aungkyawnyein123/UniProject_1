                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="">
                                            ...
                                            <div class="form-floating mb-3 mb-md-0">
                                                        <input type="text" class="form-control" placeholder="dob" disabled value="<?php $Expiredate = date('y-m-d',strtotime('+30 days',strtotime($resultUser["RegDate"]))); echo $Expiredate; ?>
">
