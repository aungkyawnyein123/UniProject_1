    ...
    if (isset($_POST['searchbook'])) 
            {
                ...
                $select="SELECT book.BookID, book.BookTitle, book.ISBN, book.BookImage, category.CategoryType, book.Quantity FROM book 
                        INNER JOIN category ON book.CategoryID=category.CategoryID WHERE BookTitle LIKE '%$searchbtn%' OR CategoryType LIKE '%$searchbtn%' OR ISBN LIKE '%$searchbtn%'
                            ORDER BY BookID";
        ...
        <tbody>
            ...
            <tr>
                    ...
                    <td width="25%" class="text-center">
                        <?php echo '<a class="btn btn-primary" href="BookDetail.php?BookID='. $row->BookID.'">View</a>';?> &nbsp
                        <?php echo '<a class="btn btn-primary" href="BookEdit.php?BookID='. $row->BookID.'">Edit</a>';?>&nbsp
                        <?php echo '<a class="btn btn-danger" onclick="return confirm(\'Confirm Delete?\')" href="BookDelete.php?BookID='. $row->BookID.'">Delete</a>';?>
