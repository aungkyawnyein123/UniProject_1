<?php
    ...
    $select="SELECT issuelog.LogID, user.UserID, book.BookID, issuelog.DueDate, issuelog.StartDate, issue.IssueID, user.FullName, book.BookTitle, book.ISBN, book.BookImage FROM issuelog
LEFT JOIN issue On issue.IssueID=issuelog.IssueID
    ...
    WHERE user.UserID='$UserID' ORDER BY issue.IssueID;";
...
<html lang="en">
    <head>
        ...
        <title>Previous Issued Books</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <table>
            <tr>
                <td class="float-left"><h4>Previous Issued Books</h4></td>
