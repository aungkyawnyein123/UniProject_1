<?php
    ...
    $select="SELECT issue.IssueID, book.BookTitle, book.ISBN, book.BookImage FROM issue INNER JOIN book ON issue.BookID=book.BookID WHERE UserID='$UserID' AND issue.status=0";
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <table>
            <tr>
                <td class="float-left"><h4>Requested Book List</h4></td>
        ...
        <tbody>
            ...
            <tr>
                    ...
                    <td width="25%" class="text-center">
                        <?php echo '<a class="btn btn-danger" onclick="return confirm(\'Cancel Book Request?\')" href="CancelBook.php?IssueID='. $row->IssueID.'">Cancel</a>';?>&nbsp
